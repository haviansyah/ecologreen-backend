...
<x-adminlte-input enable-old-support required name="bank_name" label="Bank Name"
    placeholder="Insert Bank Name eg: BNI" />
<x-adminlte-input enable-old-support required name="account_number" label="Account Number"
    placeholder="Insert Account Number eg: 299209923" />
<x-adminlte-input enable-old-support required name="account_holder_name" label="Account Holder Name"
    placeholder="Insert Account Holder Name eg: PT. Kobantitar" />
